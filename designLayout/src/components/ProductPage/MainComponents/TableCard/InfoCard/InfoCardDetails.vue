...
const {isRisk,isFirst,price} = defineProps(['isRisk','isFirst','price'])

let title= computed(()=>{
     if(isFirst){
        return isRisk? 'Disruption':'Price'
     }
     return isRisk? 'Erosion':'Volume'
})
...
<template>
        ...
        <div class="d-flex flex-sm-nowrap flex-wrap gap-2 border align-items-center fs-6 border-table-green rounded-3 p-2">
             ...
             <div class="ms-auto">
                <img src="../../../../../assets/arrows/arrow.svg" alt="arrow">
             </div>
        </div>
